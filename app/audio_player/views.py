...
def index(request):
    return HttpResponse("Index page - UI not implemented")
    # return render(request, "index.html")


# @login_required
def user_profile(request, username):
    return HttpResponse(f"User profile for {username} - UI not implemented")
...
def edit_user_profile(request):
    return HttpResponse("Edit user profile - UI not implemented")
...
def register_request(request):
    return HttpResponse("Registration - UI not implemented")
    # if request.method == "POST":
...
def login_request(request):
    return HttpResponse("Login - UI not implemented")
    # if request.method == "POST":
...
class ChangePasswordView:
    def as_view(self):
        return lambda request: HttpResponse("Change password - UI not implemented")
